        ...
        <div class="d-flex content-container">
            <div class="main-menu">
                ...
                <div class="menu">
                    ...
                    <a onclick="window.open('../manage_staffs/', '_self');"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill-gear" viewBox="0 0 16 16">
            ...
            <div class="main-content">
                <br>
                <h1 class="text-white text-center">Attendance </h1>
                ...
                <div style="min-height: 75vh;max-height:75vh;overflow: auto;">
                    <table>
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT * FROM machines WHERE company_id = '". $_SESSION['companyid'] . "'";
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                attendance($conn, $branch);
                            }

                            function attendance($conn, $branch) {
                                $sql = "SELECT name, position, department, time_logs, status, date, branch FROM attendance WHERE company_id = '". $_SESSION['companyid'] . "' ORDER BY id DESC LIMIT 50";
                                $result = $conn->query($sql);
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while($row = $result->fetch_assoc()) {
                                        ...
                                        foreach($branch as $br) {
                                            if ($br['machine_id'] == $row['branch']) {
                                                $br_name = $br['branch_name'];
                                            }
                                        }
