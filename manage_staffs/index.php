        ...
        <div class="d-flex content-container">
            <div class="main-menu">
                ...
                <div class="menu">
                    ...
                    <a onclick="window.open('../staffs/', '_self');"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                    ...
                    <div class="buttons-wrapper">
                        ...
                        <div>
                            ...
                            <div class="button <?php if (isset($_SESSION['authorized'])) { echo 'settings'; }?>" style="position:relative;">
                                <span class="must" style="background:orange;border:1px solid var(--dark-teal);position:absolute;top:-5px;right:-5px;padding:10px;border-radius:50%;"></span>
