...
<div class="container-fluid">
    <div class="row justify-content-center align-items-center">
        <div class="d-flex content-container">
            <div class="main-menu">
                <div class="fingerprint-login  pt-3">
                    <div style="padding:5px;margin-right:5px;display:flex;flex-direction:column;align-items:center;">
                        <div style="width:150px;">
                            <img src="../src/images/Logo.png" style="width:100%;"/>
                        </div>
                        <p class="text-white text-center" style="text-transform: uppercase;text-shadow:0 0 5px #fff">Payroll System </p>
                    </div>
                </div>
                <hr>
                <div class="menu">
                    ...
                    <div class="buttons-wrapper">
                        <?php 
                            if (isset($_SESSION['admin'])) {
                               ...
                               if (in_array('view staffs', $permissions)) {
                                    echo '<div>
                                    <p>Staffs</p>
                                        <div class="button view-staffs">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                        ...
                        if (isset($_SESSION['admin'])) {
                            echo '<div>
                            <p>Add Staff</p>
                            <div class="button add-staff"  style="position:relative;">';
                        } else {
                        ...
                        <?php 
                        if (isset($_SESSION['admin'])) {
                            echo '<svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-person-fill-add" viewBox="0 0 16 16">
                        ...
                        if (isset($_SESSION['admin'])) {
                            ...
                            if (in_array('edit staff', $permissions)) {
                                echo '<div>
                                <p>Edit Staff</p>
                                <div class="button edit-staff">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-person-fill-dash" viewBox="0 0 16 16">
                        ...
                        if (isset($_SESSION['admin'])) {
                            echo '<div>
                                <p>Logs</p>
                                <div class="button">
                                <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-journal-text" viewBox="0 0 16 16">
                        ...
                        if (isset($_SESSION['admin'])) {
                            echo '<div>
                            <p>Settings</p>
                            <div class="button settings" style="position:relative;">';
                        ...
                        <?php 
                        if (isset($_SESSION['admin'])) {
                                echo '<svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-gear-fill" viewBox="0 0 16 16">
                        ...
                        if (isset($_SESSION['admin'])) {
                            echo '<div>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-person-fill-gear" viewBox="0 0 16 16">
                                    <path d="M11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0m-9 8c0 1 1 1 1 1h5.256A4.5 4.5 0 0 1 8 12.5a4.5 4.5 0 0 1 1.544-3.393Q8.844 9.002 8 9c-5 0-6 3-6 4m9.886-3.54c.18-.613 1.048-.613 1.229 0l.043.148a.64.64 0 0 0 .921.382l.136-.074c.561-.306 1.175.308.87.869l-.075.136a.64.64 0 0 0 .382.92l.149.045c.612.18.612 1.048 0 1.229l-.15.043a.64.64 0 0 0-.38.921l.074.136c.305.561-.309 1.175-.87.87l-.136-.075a.64.64 0 0 0-.92.382l-.045.149c-.18.612-1.048.612-1.229 0l-.043-.15a.64.64 0 0 0-.921-.38l-.136.074c-.561.305-1.175-.309-.87-.87l.075-.136a.64.64 0 0 0-.382-.92l-.148-.045c-.613-.18-.613-1.048 0-1.229l.148-.043a.64.64 0 0 0 .382-.921l-.074-.136c-.306-.561.308-1.175.869-.87l.136.075a.64.64 0 0 0 .92-.382zM14 12.5a1.5 1.5 0 1 0-3 0 1.5 1.5 0 0 0 3 0"/>
                                </svg>
                                </div>
                            </div>';
                        ...
                        if (isset($_SESSION['admin'])) {
                            echo '<div>
                                <p>Branch</p>
                                <div class="button view-machines">
...
<script src="../src/contribution.js"></script>
</body>
</html>
