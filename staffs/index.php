...
<html>
<head>
    <title>Biometric Attendance | Staffs</title>
    <meta charset="utf-8">
        ...
        <div class="d-flex content-container">
            <div class="main-menu">
                ...
                <div class="menu">
                    ...
                    <a class="active"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
            ...
            <div class="main-content">
                ...
                ?>
                <h1 class="text-white text-center">Employees (<?php echo $numOfEmployees; ?>)</h1>
